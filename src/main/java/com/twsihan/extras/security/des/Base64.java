...
import com.twsihan.extras.security.encoder.BASE64Decoder;
import com.twsihan.extras.security.encoder.BASE64Encoder;
...
public class Base64
{
    ...
    private final static byte[] _NATIVE_ALPHABET = {
            ...
            (byte) '2', (byte) '3', (byte) '4', (byte) '5', (byte) '6', (byte) '7', (byte) '8', (byte) '9', (byte) '_', (byte) '-'
    };
    ...
    static {
        byte[] __bytes;
        try {
            __bytes = new String("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_-")
    ...
    final static byte BAD_ENCODING = -9; // Indicates error in encoding
    ...
    static byte[] encode3to4(byte[] threeBytes)
    {
